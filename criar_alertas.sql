/*
Cria uma sequencia de alertas interessantes para o SQL Server.
Não esqueça de configurar o SQL Mail para receber esses alertas no seu Email.
*/
...
DECLARE @Sev16AlertName sysname = N'Alert - Sev 16 Error: Miscellaneous User Error';
DECLARE @Sev17AlertName sysname = N'Alert - Sev 17 Error: Insufficient Resources';
DECLARE @Sev18AlertName sysname = N'Alert - Sev 18 Error: NonFatal Internal Error';
DECLARE @Sev19AlertName sysname = N'Alert - Sev 19 Error: Fatal Error in Resource';
DECLARE @Sev20AlertName sysname = N'Alert - Sev 20 Error: Fatal Error in Current Process';
DECLARE @Sev21AlertName sysname = N'Alert - Sev 21 Error: Fatal Error in Database Process';
DECLARE @Sev22AlertName sysname = N'Alert - Sev 22 Error: Fatal Error: Table Integrity Suspect';
DECLARE @Sev23AlertName sysname = N'Alert - Sev 23 Error: Fatal Error Database Integrity Suspect';
DECLARE @Sev24AlertName sysname = N'Alert - Sev 24 Error: Fatal Hardware Error';
DECLARE @Sev25AlertName sysname = N'Alert - Sev 25 Error: Fatal Error';
...
IF NOT EXISTS (SELECT name FROM msdb.dbo.sysalerts WHERE name = @Sev21AlertName)
	EXEC msdb.dbo.sp_add_alert @name = @Sev21AlertName, 
				  ...
				  @delay_between_responses = 300, @include_event_description_in = 1,
				  @category_name = @CategoryName, 
				  @job_id = N'00000000-0000-0000-0000-000000000000';
